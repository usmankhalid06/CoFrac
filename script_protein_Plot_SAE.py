...
import py3Dmol
ATOMS = {1: "Transmembrane", 32: "Disulfide bond", 196: "DNA binding"}
PREFERRED = {1: None, 32: None, 196: None}
def load_af_for_atom(atom):
    df = pd.read_csv(f"atom{atom}_SAE.csv")
...
for atom, concept in ATOMS.items():
    ...
    fn = f"struct_atom{atom}_SAE.html"
