...
import py3Dmol
ATOMS = {36: "Transmembrane", 61: "Disulfide bond", 125: "DNA binding"}
PREFERRED = {36: None, 61: None, 125: None}
def load_af_for_atom(atom):
    df = pd.read_csv(f"atom{atom}_LSICA.csv")
...
for atom, concept in ATOMS.items():
    ...
    fn = f"struct_atom{atom}_LSICA.html"
